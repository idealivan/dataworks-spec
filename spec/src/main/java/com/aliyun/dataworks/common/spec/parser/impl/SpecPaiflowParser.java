 ...
 */
@SpecParser
public class SpecPaiflowParser extends DefaultSpecParser<SpecPaiflow> {
    public static final String PAIFLOW = "paiflow";

    @Override
    public SpecPaiflow parse(Map<String, Object> rawContext, SpecParserContext specParserContext) {
        SpecPaiflow specPaiflow = new SpecPaiflow();

        SpecDevUtil.setSameKeyField(rawContext, specPaiflow, specParserContext);
